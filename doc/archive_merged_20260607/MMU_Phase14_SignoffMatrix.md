...
| S3 | Code coverage: line >=99.5%, branch >=99%, toggle >=98%, FSM >=99% | Open | DUT `u_dut` authoritative aggregate (MMU-P14-ISSUE-021 corrected prior false-100% parser): line 96.71%, branch 94.13%, toggle 72.34%, FSM 86.10% — all below threshold; post structural exclusion (toggle reset/DFT + FSM reset-path); closure in progress under MMU-P14-ISSUE-022 | MMU-P14-ISSUE-021, MMU-P14-ISSUE-022 | Phase14 Closure Owner | TBD |
...
| S5 | Assertion coverage 100% triggered, 0 fail | Open | DUT `u_dut` (MMU-P14-ISSUE-021): assert 86.95% below 100.00%; 0 failing assertions in regression; closure in progress under MMU-P14-ISSUE-022 | MMU-P14-ISSUE-021, MMU-P14-ISSUE-022 | Phase14 Closure Owner | TBD |
