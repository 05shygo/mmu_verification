...
| S3 | Code coverage: line >=99.5%, branch >=99%, toggle >=98%, FSM >=99% | Waived | DUT `u_dut` authoritative aggregate (MMU-P14-ISSUE-021 corrected prior false-100% parser): line 98.17%, branch 96.34%, toggle 78.62%, FSM 95.09%, assert 88.08% — all below threshold; structural exclusions applied (MMU-P14-ISSUE-022); remaining toggle/FSM gaps tracked under MMU-P14-ISSUE-022 | MMU-P14-ISSUE-021, MMU-P14-ISSUE-022 | Phase14 Closure Owner | Reviewed |
...
| S5 | Assertion coverage 100% triggered, 0 fail | Waived | DUT `u_dut` (MMU-P14-ISSUE-021): assert 88.08% below 100.00%; 0 failing assertions in regression; closure in progress under MMU-P14-ISSUE-022 | MMU-P14-ISSUE-021, MMU-P14-ISSUE-022 | Phase14 Closure Owner | Reviewed |
