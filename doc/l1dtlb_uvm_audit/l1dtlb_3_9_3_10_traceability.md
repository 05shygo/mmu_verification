...
| L1DTLB_TS_OBS_LEGAL_NO_RESPONSE | partial | abort/CAM/full/flush/busy/priority negative checks plus spec-SB reason counters exist; transaction-level reason annotation remains pending. |
