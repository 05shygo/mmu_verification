...
// &Regs; @25
logic     [4 :0]  hit_num_flop;          
logic     [4 :0]  hit_num_index;         
logic             p00;                   
logic             p10;                   
logic             p11;                   
logic             p20;                   
...
logic             p4e;                   
logic             p4f;                   
logic     [4 :0]  refill_num_index;      
logic     [31:0]  refill_num_onehot;     
logic     [4 :0]  write_num;             

// &Wires; @26
logic    [31:0]  hit_num_onehot;        
logic            lru_clk;               
logic            lru_clk_en;            
...
logic            p40_read_updt;         
logic            p40_read_updt_val;     
logic            p40_write_updt;        
logic            p40_write_updt_val;    
logic            p41_read_updt;         
logic            p41_read_updt_val;     
logic            p41_write_updt;        
logic            p41_write_updt_val;    
logic            p42_read_updt;         
logic            p42_read_updt_val;     
logic            p42_write_updt;        
logic            p42_write_updt_val;    
logic            p43_read_updt;         
logic            p43_read_updt_val;     
logic            p43_write_updt;        
logic            p43_write_updt_val;    
logic            p44_read_updt;         
logic            p44_read_updt_val;     
logic            p44_write_updt;        
logic            p44_write_updt_val;    
logic            p45_read_updt;         
logic            p45_read_updt_val;     
logic            p45_write_updt;        
logic            p45_write_updt_val;    
logic            p46_read_updt;         
logic            p46_read_updt_val;     
logic            p46_write_updt;        
logic            p46_write_updt_val;    
logic            p47_read_updt;         
logic            p47_read_updt_val;     
logic            p47_write_updt;        
logic            p47_write_updt_val;    
logic            p48_read_updt;         
logic            p48_read_updt_val;     
logic            p48_write_updt;        
logic            p48_write_updt_val;    
logic            p49_read_updt;         
logic            p49_read_updt_val;     
logic            p49_write_updt;        
logic            p49_write_updt_val;    
logic            p4a_read_updt;         
logic            p4a_read_updt_val;     
logic            p4a_write_updt;        
logic            p4a_write_updt_val;    
logic            p4b_read_updt;         
logic            p4b_read_updt_val;     
logic            p4b_write_updt;        
logic            p4b_write_updt_val;    
logic            p4c_read_updt;         
logic            p4c_read_updt_val;     
logic            p4c_write_updt;        
logic            p4c_write_updt_val;    
logic            p4d_read_updt;         
logic            p4d_read_updt_val;     
logic            p4d_write_updt;        
logic            p4d_write_updt_val;    
logic            p4e_read_updt;         
logic            p4e_read_updt_val;     
logic            p4e_write_updt;        
logic            p4e_write_updt_val;    
logic            p4f_read_updt;         
logic            p4f_read_updt_val;     
logic            p4f_write_updt;        
logic            p4f_write_updt_val;    
logic    [4 :0]  plru_num;              
logic            plru_read_updt;        
logic            plru_write_updt;       
logic    [31:0]  vld_entry_num;         
