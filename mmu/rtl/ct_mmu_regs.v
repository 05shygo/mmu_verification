...
//jtlb => regs(mel and meh)tlbr
input  logic [15:0]  jtlb_tlbr_asid,//meh         
input  logic [13:0]  jtlb_tlbr_flg, //mel           
input  logic         jtlb_tlbr_g,   //mel           
input  logic [2 :0]  jtlb_tlbr_pgs, //meh           
input  logic [27:0]  jtlb_tlbr_ppn, //mel          
input  logic [26:0]  jtlb_tlbr_vpn, //meh
...
logic             mel_vld;                 
logic             mel_write;               
logic     [11:0]  mir_index;               
logic             mir_probe;               
logic             mir_tlbp_tfatal;         
...
logic    [63:0]  mcir_data;               
logic            mcir_data_no_op;         
logic            mcir_write_en;           
logic    [63:0]  meh_data;                
logic            meh_write_en;            
logic    [63:0]  mel_data;                
...
logic            mir_write_en;            
logic            mmu_regs_clk;            
logic            mmu_regs_clk_en;         
logic    [63:0]  satp_data;               
logic            satp_write_en;           
logic            wdata_invall;            
logic            wdata_invasid;           
logic            wdata_tlbp;              
