...
//----------------------------------------------------------
    ...
    assign pfu_ref_ppn[PPN_WIDTH-1:0] = ptw_l2tlb_ref_cmplt & (ptw_l2tlb_ref_type == 3'b100) ? ptw_l2tlb_ref_ppn[PPN_WIDTH-1:0]
                                                           : final_hit_ppn[PPN_WIDTH-1:0];
    assign pfu_ref_pgs[PGS_WIDTH-1:0] = ptw_l2tlb_ref_cmplt & (ptw_l2tlb_ref_type == 3'b100) ? ptw_l2tlb_ref_pgs[PGS_WIDTH-1:0]
                                                           : final_hit_pgs[PGS_WIDTH-1:0];
    assign pfu_ref_flg[FLG_WIDTH-1:0] = ptw_l2tlb_ref_cmplt & (ptw_l2tlb_ref_type == 3'b100) ? ptw_l2tlb_ref_flg[FLG_WIDTH-1:0]
