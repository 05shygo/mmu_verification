...
input           mmu_pmp_fetch5;    
input           mmu_pmp_fetch6;    
input           mmu_pmp_fetch7;    
input   [27:0]  mmu_pmp_pa0;       
input   [27:0]  mmu_pmp_pa1;       
input   [27:0]  mmu_pmp_pa2;       
input   [27:0]  mmu_pmp_pa3;       
input   [27:0]  mmu_pmp_pa4;       
input   [27:0]  mmu_pmp_pa5;       
input   [27:0]  mmu_pmp_pa6;       
input   [27:0]  mmu_pmp_pa7;       
...
output  [3 :0]  pmp_mmu_flg5;      
output  [3 :0]  pmp_mmu_flg6;      
output  [3 :0]  pmp_mmu_flg7;      
output          pmp_regs_update; 
// &Regs; @26
...
wire    [27:0]  mmu_pmp_pa5;       
wire    [27:0]  mmu_pmp_pa6;       
wire    [27:0]  mmu_pmp_pa7;       
...
wire    [3 :0]  pmp_mmu_flg5;
wire    [3 :0]  pmp_mmu_flg6;
wire    [3 :0]  pmp_mmu_flg7;
wire            pmp_mprv_status0;  
wire            pmp_mprv_status1;  
wire            pmp_mprv_status2;  
wire            pmp_mprv_status3;  
wire            pmp_mprv_status4;  
wire            pmp_mprv_status5;  
wire            pmp_mprv_status6;  
wire            pmp_mprv_status7;  
...
wire            wr_pmp_regs;       
wire            pmp_regs_update;   
wire    [9 :0]  pmp_mmu_regs;  
...
assign pmp_mmu_regs[8:0] = {wr_pmp_regs[9:2],wr_pmp_regs[0]};
assign pmp_regs_update = |pmp_mmu_regs[9:0];
...
assign pmp_mprv_status5 = cp0_pmp_mprv && !mmu_pmp_fetch5;
assign pmp_mprv_status6 = cp0_pmp_mprv && !mmu_pmp_fetch6;
assign pmp_mprv_status7 = cp0_pmp_mprv && !mmu_pmp_fetch7;
// &ConnRule(s/_y/0/); @136
...
ct_pmp_acc  x_ct_pmp_acc5 (
  .cp0_pmp_mpp       (cp0_pmp_mpp      ),
  .cur_priv_mode     (cur_priv_mode    ),
  .mmu_pmp_pa_y      (mmu_pmp_pa5      ),
  .pmp_mmu_flg_y     (pmp_mmu_flg5     ),
  .pmp_mprv_status_y (pmp_mprv_status5 ),
  .pmpaddr0_value    (pmpaddr0_value   ),
  .pmpaddr1_value    (pmpaddr1_value   ),
  .pmpaddr2_value    (pmpaddr2_value   ),
  .pmpaddr3_value    (pmpaddr3_value   ),
...
ct_pmp_acc  x_ct_pmp_acc6 (
  .cp0_pmp_mpp       (cp0_pmp_mpp      ),
  .cur_priv_mode     (cur_priv_mode    ),
  .mmu_pmp_pa_y      (mmu_pmp_pa6      ),
  .pmp_mmu_flg_y     (pmp_mmu_flg6     ),
  .pmp_mprv_status_y (pmp_mprv_status6 ),
  .pmpaddr0_value    (pmpaddr0_value   ),
  .pmpaddr1_value    (pmpaddr1_value   ),
  .pmpaddr2_value    (pmpaddr2_value   ),
  .pmpaddr3_value    (pmpaddr3_value   ),
...
ct_pmp_acc  x_ct_pmp_acc7 (
  .cp0_pmp_mpp       (cp0_pmp_mpp      ),
  .cur_priv_mode     (cur_priv_mode    ),
  .mmu_pmp_pa_y      (mmu_pmp_pa7      ),
  .pmp_mmu_flg_y     (pmp_mmu_flg7     ),
  .pmp_mprv_status_y (pmp_mprv_status7 ),
  .pmpaddr0_value    (pmpaddr0_value   ),
  .pmpaddr1_value    (pmpaddr1_value   ),
  .pmpaddr2_value    (pmpaddr2_value   ),
  .pmpaddr3_value    (pmpaddr3_value   ),
