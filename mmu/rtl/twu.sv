...
assign twu_data_ready[PTE_LEVEL-1:0] = {fst_chk_ready,scd_chk_ready,thd_chk_ready};
...
always_ff@(posedge twu_clk or negedge cpurst_b) begin
	if(!cpurst_b)begin
		...
		twu_pgflt_type[TYPE_WIDTH-1:0] <= thd_chk_type[TYPE_WIDTH-1:0];
		...
		twu_pgflt_type[TYPE_WIDTH-1:0] <= scd_chk_type[TYPE_WIDTH-1:0];
		...
		twu_pgflt_type[TYPE_WIDTH-1:0] <= fst_chk_type[TYPE_WIDTH-1:0];
...
always_ff@(posedge twu_clk or negedge cpurst_b) begin
	if(!cpurst_b)begin
		...
		twu_acc_err_type[TYPE_WIDTH-1:0] <= thd_pmp_type[TYPE_WIDTH-1:0];
		...
		twu_acc_err_type[TYPE_WIDTH-1:0] <= scd_pmp_type[TYPE_WIDTH-1:0];
		...
		twu_acc_err_type[TYPE_WIDTH-1:0] <= fst_pmp_type[TYPE_WIDTH-1:0];
...
always_ff @(posedge twu_clk or negedge cpurst_b)begin
	...
	end else if(csr_grant[1] & csr_idle)begin
	...
	end else if(csr_grant[0] & csr_idle)begin
		twu_sysmap_adderx1[PADDR_WIDTH-1:0] <= {csr_data[PPN_WIDTH+9:10], 12'b0};
...
always_ff@(posedge twu_clk or negedge cpurst_b) begin
	if(!cpurst_b)begin
		...
		twu_ref_data_din[RDATA_WIDTH-1:0] <= thd_chk_refill_data[RDATA_WIDTH-1:0];
		twu_ref_tag_din[TAG_WIDTH-1:0] = thd_chk_refill_tag[TAG_WIDTH-1:0];
		twu_ref_pgs[PGS_WIDTH-1:0] <= 3'b001;
		twu_ref_type[TYPE_WIDTH-1:0] <= thd_chk_refill_type[TYPE_WIDTH-1:0];
		twu_ref_id[ID_WIDTH-1:0] <= thd_chk_refill_id[ID_WIDTH-1:0];
	end else if(refill_grant[1] & twu_refill_idle)begin
		twu_ref_data_din[RDATA_WIDTH-1:0] <= scd_chk_refill_data[RDATA_WIDTH-1:0];
		twu_ref_tag_din[TAG_WIDTH-1:0] = scd_chk_refill_tag[TAG_WIDTH-1:0];
		twu_ref_pgs[PGS_WIDTH-1:0] <= 3'b010;
		twu_ref_type[TYPE_WIDTH-1:0] <= scd_chk_refill_type[TYPE_WIDTH-1:0];
		twu_ref_id[ID_WIDTH-1:0] <= scd_chk_refill_id[ID_WIDTH-1:0];
	end else if(refill_grant[2] & twu_refill_idle)begin
		twu_ref_data_din[RDATA_WIDTH-1:0] <= fst_chk_refill_data[RDATA_WIDTH-1:0];
		twu_ref_tag_din[TAG_WIDTH-1:0] <= fst_chk_refill_tag[TAG_WIDTH-1:0];
		twu_ref_pgs[PGS_WIDTH-1:0] <= 3'b100;
		twu_ref_type[TYPE_WIDTH-1:0] <= fst_chk_refill_type[TYPE_WIDTH-1:0];
		twu_ref_id[ID_WIDTH-1:0] <= fst_chk_refill_id[ID_WIDTH-1:0];
		...
		twu_ref_pgs[PGS_WIDTH-1:0] <= csr_refill_pgs[2:0];
		twu_ref_type[TYPE_WIDTH-1:0] <= csr_refill_type[TYPE_WIDTH-1:0];
		twu_ref_id[ID_WIDTH-1:0] <= csr_refill_id[ID_WIDTH-1:0];
	end
end

assign twu_arb_ref_data_din[RDATA_WIDTH-1:0] = thd_chk_refill_no_maee_sel ? thd_chk_refill_data_no_maee[RDATA_WIDTH-1:0] : twu_ref_data_din[RDATA_WIDTH-1:0];
...
//			twu_arb_ref_type[TYPE_WIDTH-1:0] = thd_chk_refill_type[TYPE_WIDTH-1:0];
...
//			twu_arb_ref_type[TYPE_WIDTH-1:0] = scd_chk_refill_type[TYPE_WIDTH-1:0];
...
//			twu_arb_ref_type[TYPE_WIDTH-1:0] = fst_chk_refill_type[TYPE_WIDTH-1:0];
...
//			twu_arb_ref_type[TYPE_WIDTH-1:0] = csr_refill_type[TYPE_WIDTH-1:0];
...
//			twu_arb_ref_type[TYPE_WIDTH-1:0] = {TYPE_WIDTH{1'b0}};
