// =============================================================================
// Phase 12 generated test wrapper for TC-TWU-MAEE0-CSR-001
// F-ID: F4.NEW.12  Priority: P0  Status: Implemented
// Checker: sva_twu_maee_paths_mutex + cg_maee_leaf_level  Reviewer: A+B
// =============================================================================
`ifndef TEST_MMU_TWU_MAEE0_CSR_PATH_SVH
`define TEST_MMU_TWU_MAEE0_CSR_PATH_SVH

class test_mmu_twu_maee0_csr_path extends phase12_generated_test_base;

  `uvm_component_utils(test_mmu_twu_maee0_csr_path)
  ...
  protected virtual function void setup_phase12_plan();
    p12_bucket   = "maee_twu";
    p12_trace_id = "TC-TWU-MAEE0-CSR-001";
    p12_fid      = "F4.NEW.12";
    p12_priority = "P0";
    p12_status   = "Implemented";
    p12_seq_desc = "cp0_maee_disable_seq + mmu_huge_page_mix_vseq";
...
endclass : test_mmu_twu_maee0_csr_path

`endif // TEST_MMU_TWU_MAEE0_CSR_PATH_SVH
