...
class phase9_generated_test_base extends test_base;
  ...
  protected virtual task start_vseq_by_name(string seq_name);
    ...
    case (seq_name)
      ...
      "mmu_l1dtlb_entry_sweep_vseq": seq = mmu_l1dtlb_entry_sweep_vseq::type_id::create(seq_name);
      "mmu_l2tlb_pfu_chk_deny_vseq":    seq = mmu_l2tlb_pfu_chk_deny_vseq::type_id::create(seq_name);
      "mmu_l2tlb_pfu_chk_via_clean_entry_vseq": seq = mmu_l2tlb_pfu_chk_via_clean_entry_vseq::type_id::create(seq_name);
      "mmu_l2tlb_multiway_hit_vseq":          seq = mmu_l2tlb_multiway_hit_vseq::type_id::create(seq_name);
      "mmu_l2tlb_acc_type_sweep_vseq":        seq = mmu_l2tlb_acc_type_sweep_vseq::type_id::create(seq_name);
      "mmu_l2tlb_mb_full_vseq":               seq = mmu_l2tlb_mb_full_vseq::type_id::create(seq_name);
      "mmu_l2tlb_par_fail_vseq":              seq = mmu_l2tlb_par_fail_vseq::type_id::create(seq_name);
      "mmu_l2tlb_rrpv_wbuf_full_vseq":        seq = mmu_l2tlb_rrpv_wbuf_full_vseq::type_id::create(seq_name);
      "mmu_l2tlb_reqq_depth_vseq":            seq = mmu_l2tlb_reqq_depth_vseq::type_id::create(seq_name);
      "mmu_l2tlb_cond_1234_vseq":           seq = mmu_l2tlb_cond_1234_vseq::type_id::create(seq_name);
      "mmu_l2tlb_cond_1234b_vseq":          seq = mmu_l2tlb_cond_1234b_vseq::type_id::create(seq_name);
      "mmu_l2tlb_ptw_disabled_vseq":        seq = mmu_l2tlb_ptw_disabled_vseq::type_id::create(seq_name);
      "mmu_l2tlb_ptw_off_vseq":             seq = mmu_l2tlb_ptw_off_vseq::type_id::create(seq_name);
      "mmu_l2tlb_ptw_off_v3_vseq":        seq = mmu_l2tlb_ptw_off_v3_vseq::type_id::create(seq_name);
      "mmu_l2tlb_diag_ptw_en_vseq":        seq = mmu_l2tlb_diag_ptw_en_vseq::type_id::create(seq_name);
      "mmu_l2tlb_cond_769_vseq":             seq = mmu_l2tlb_cond_769_vseq::type_id::create(seq_name);
      "mmu_l2tlb_mid_reset_vseq":             seq = mmu_l2tlb_mid_reset_vseq::type_id::create(seq_name);
      "mmu_l2tlb_pfu_fullpath_vseq":          seq = mmu_l2tlb_pfu_fullpath_vseq::type_id::create(seq_name);
      "mmu_l2tlb_pfu_fault_sweep_vseq":       seq = mmu_l2tlb_pfu_fault_sweep_vseq::type_id::create(seq_name);
      "mmu_l2tlb_arb_write_sweep_vseq":       seq = mmu_l2tlb_arb_write_sweep_vseq::type_id::create(seq_name);
      "mmu_l2tlb_multiway_hit2_vseq":         seq = mmu_l2tlb_multiway_hit2_vseq::type_id::create(seq_name);
      "mmu_l2tlb_par_fail2_vseq":             seq = mmu_l2tlb_par_fail2_vseq::type_id::create(seq_name);
      "mmu_l2tlb_pgflt_ptw_off_vseq":         seq = mmu_l2tlb_pgflt_ptw_off_vseq::type_id::create(seq_name);
      ...
      "mmu_l2tlb_toggle_sram_vseq":           seq = mmu_l2tlb_toggle_sram_vseq::type_id::create(seq_name);
      "mmu_l2tlb_toggle_highaddr_vseq":       seq = mmu_l2tlb_toggle_highaddr_vseq::type_id::create(seq_name);
      "mmu_l2tlb_toggle_small_modules_vseq":  seq = mmu_l2tlb_toggle_small_modules_vseq::type_id::create(seq_name);
      "mmu_l1dtlb_toggle_entry_sweep_vseq":   seq = mmu_l1dtlb_toggle_entry_sweep_vseq::type_id::create(seq_name);
      "mmu_l1dtlb_toggle_expt_cam_full_vseq": seq = mmu_l1dtlb_toggle_expt_cam_full_vseq::type_id::create(seq_name);
      "mmu_l2tlb_toggle_sram_v2_vseq":        seq = mmu_l2tlb_toggle_sram_v2_vseq::type_id::create(seq_name);
      "mmu_l2tlb_toggle_highaddr_v2_vseq":    seq = mmu_l2tlb_toggle_highaddr_v2_vseq::type_id::create(seq_name);
      "mmu_l2tlb_toggle_small_modules_v2_vseq": seq = mmu_l2tlb_toggle_small_modules_v2_vseq::type_id::create(seq_name);
