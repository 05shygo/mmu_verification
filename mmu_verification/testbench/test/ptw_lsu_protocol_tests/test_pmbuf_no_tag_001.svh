// =============================================================================
// Phase 11 generated test wrapper for TC-PMBUF-NO-TAG-001
// F-ID: F4.42b  Priority: P0  Status: Planned
// Checker: sva_vld_only_when_req  Reviewer: A+B
// =============================================================================
...
class test_pmbuf_no_tag_001 extends phase11_generated_test_base;
  ...
  protected virtual function void setup_phase11_plan();
    ...
    p11_trace_id = "TC-PMBUF-NO-TAG-001";
    p11_fid      = "F4.42b";
    p11_priority = "P0";
    p11_status   = "Planned";
    p11_seq_desc = "ptw_mem_normal_rsp_seq + lsu_mapped_pipe0_rr_seq";
    p11_checker  = "sva_vld_only_when_req";
    p11_reviewer = "A+B";
    num_txn      = 48;
    m_post_drain = 800ns;
    ...
    // which turns the no-tag check into an exception-drain scenario.
