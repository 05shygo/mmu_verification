...
class test_mmu_arb_pgs_bank_select extends phase12_generated_test_base;
  ...
  virtual task run_test_body();
    ...
    repeat (2) begin
      phase12_drive_lsu_rr(39'h0_3000_2000, 1, 4, LSU_PIPE1, 1'b1);
      phase12_cp0_tlb_allinv();
      phase12_drive_lsu_rr(39'h0_2600_0000, 1, 4, LSU_PIPE1, 1'b1);
      phase12_cp0_tlb_allinv();
      phase12_drive_lsu_rr(39'h0_8000_0000, 1, 4, LSU_PIPE1, 1'b1);
      phase12_cp0_tlb_allinv();

      phase12_drive_ifu_rr(39'h0_3000_2000, 1, 12);
      phase12_cp0_tlb_allinv();
      phase12_drive_ifu_rr(39'h0_2600_0000, 1, 12);
      phase12_cp0_tlb_allinv();
      phase12_drive_ifu_rr(39'h0_8000_0000, 1, 12);
      phase12_cp0_tlb_allinv();
    end
