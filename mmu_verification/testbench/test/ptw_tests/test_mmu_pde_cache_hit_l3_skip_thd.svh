...
class test_mmu_pde_cache_hit_l3_skip_thd extends phase12_generated_test_base;
  ...
  protected virtual function void setup_phase12_plan();
    ...
    p12_seq_desc = "all-allow pmpflg + ptw_page_table_build_1g_seq + mmu_huge_page_mix_vseq";
    p12_checker  = "sva_twu_skip_stage_on_hit + cg_xbar_hit_level + permission-qualified PDE hit";
    p12_reviewer = "A+B";
    num_txn      = 96;
    m_post_drain = 800ns;
  endfunction
