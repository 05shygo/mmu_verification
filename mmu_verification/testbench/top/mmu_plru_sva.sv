...
module mmu_plru_sva (
  ...
  a_iutlb_ref_onehot0: assert property (@(posedge forever_cpuclk) disable iff (!cpurst_b)
...
module mmu_dplru_sva (
  ...
  a_dutlb_ref_onehot0: assert property (@(posedge forever_cpuclk) disable iff (!cpurst_b)
