...
assign write_back_req = mbuf_vld & (|(twu_data_ready[(idx)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)] & mbuf_lvl[PTE_LEVEL-1:0])) & (mbuf_on & lsu_mmu_data_vld & (!lsu_mmu_bus_error)  | mbuf_get);
