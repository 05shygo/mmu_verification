...
module mmu_arb#(
    ...
    input  logic [(WAY_NUM-1-(0)+1)*(RRPV_WIDTH-1-(0)+1)-1:0] rrpv_updata,
    ...
    assign arb_l2tlb_rrpv_din = {rrpv_updata[(7)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(6)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(5)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(4)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(3)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(2)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(1)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_updata[(0)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)]};
