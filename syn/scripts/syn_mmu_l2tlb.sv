module mmu_l2tlb#(
   ...
   // output logic                    l2tlb_l1itlb_acc_err,
    ...
    logic                       push_req;
    logic                       wbuf_push_req;
    logic [(WAY_NUM-1-(0)+1)*(IDX_WIDTH-1-(0)+1)-1:0] raw_bank_index;
    logic [(WAY_NUM-1-(0)+1)*(IDX_WIDTH-1-(0)+1)-1:0] final_bank_index;
    logic                       wbuf_full;
    logic                       wbuf_pop_grant;
    logic                       wbuf_empty;
    logic [WAY_NUM-1:0]         wbuf_cam_hit;
    logic [WAY_NUM-1:0]         rrpv_sram_vld;
    logic [(WAY_NUM-1-(0)+1)*(IDX_WIDTH-1-(0)+1)-1:0] rrpv_sram_idx;
    logic [(WAY_NUM-1-(0)+1)*(RRPV_WIDTH-1-(0)+1)-1:0] rrpv_sram_wdata;
    ...
    logic [(WAY_NUM-1-(0)+1)*(RRPV_WIDTH-1-(0)+1)-1:0] bypassed_rrpv_rdata;
    ...
    logic [(WAY_NUM-1-(0)+1)*(IDX_WIDTH-1-(0)+1)-1:0] way_index;
    ...
    logic [(WAY_NUM-1-(0)+1)*(PGS_WIDTH-1-(0)+1)-1:0] raw_way_pgs; 
    logic [(WAY_NUM-1-(0)+1)*(ASID_WIDTH-1-(0)+1)-1:0] raw_way_asid; 
    logic [WAY_NUM-1:0]                 raw_way_g;
    
    logic [(WAY_NUM-1-(0)+1)*(VPN_WIDTH-1-(0)+1)-1:0] raw_vpn_masked;
    logic [(WAY_NUM-1-(0)+1)*(VPN_WIDTH-1-(0)+1)-1:0] raw_way_vpn;
    ...
    logic [(WAY_NUM-1-(0)+1)*(VPN_WIDTH-1-(0)+1)-1:0] final_way_vpn;
    logic [(WAY_NUM-1-(0)+1)*(PGS_WIDTH-1-(0)+1)-1:0] final_way_pgs;
    logic [(WAY_NUM-1-(0)+1)*(ASID_WIDTH-1-(0)+1)-1:0] final_way_asid;
    logic [WAY_NUM-1:0]         final_way_g;
    logic [(WAY_NUM-1-(0)+1)*(PPN_WIDTH-1-(0)+1)-1:0] final_way_ppn;
    logic [(WAY_NUM-1-(0)+1)*(FLG_WIDTH-1-(0)+1)-1:0] final_way_flg;
    ...
    assign rrpv_lookup_updata = {rrpv_sram_wdata[(7)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(6)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(5)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(4)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(3)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(2)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(1)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)],rrpv_sram_wdata[(0)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)]};
    ...
    always_comb begin
        for (int i = 0; i < WAY_NUM; i++) begin
            l2tlb_rrpv_merged_dout_bus[i*RRPV_WIDTH +: RRPV_WIDTH] =
                wbuf_cam_hit[i] ? bypassed_rrpv_rdata[(i)*(RRPV_WIDTH-1-(0)+1)+0 +: (RRPV_WIDTH-1-(0)+1)]
    ...
    assign way_index[(0)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w0;
    assign way_index[(1)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w1;
    assign way_index[(2)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w2;
    assign way_index[(3)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w3;
    assign way_index[(4)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w4;
    assign way_index[(5)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w5;
    assign way_index[(6)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w6;
    assign way_index[(7)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)] = arb_l2tlb_idx_w7;
    ...
    //assign raw_vpn_masked[(VPN_WIDTH-1:0)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)] = {VPN_WIDTH{l2tlb_cur_pgs[0]}} & raw_vpn_4k[VPN_WIDTH-1:0]
    ...
    generate
        for(i = 0;i < WAY_NUM;i++) begin: hit_determination            
            ...
            assign raw_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]  = raw_way_tag[i][TAG_WIDTH-2:TAG_WIDTH-1-VPN_WIDTH]; 
            assign raw_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]  = raw_way_tag[i][TAG_WIDTH-2-VPN_WIDTH-ASID_WIDTH:1];
            assign raw_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)] = raw_way_tag[i][TAG_WIDTH-2-VPN_WIDTH:TAG_WIDTH-1-VPN_WIDTH-ASID_WIDTH];
            assign raw_way_g[i]    = raw_way_tag[i][0];

            assign raw_vpn_masked[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)] = {VPN_WIDTH{l2tlb_cur_pgs[i][0]}} & raw_vpn_4k[VPN_WIDTH-1:0]
                                       | {VPN_WIDTH{l2tlb_cur_pgs[i][1]}} &  raw_vpn_2m[VPN_WIDTH-1:0]
                                       | {VPN_WIDTH{l2tlb_cur_pgs[i][2]}} &  raw_vpn_1g[VPN_WIDTH-1:0];

           //way raw hit logic
            assign raw_way_hit_kid0[i] = (raw_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]   == raw_vpn_masked[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]);
            assign raw_way_hit_kid1[i] = (raw_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]  == raw_vpn_masked[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)])
                                           && l2tlb_cur_pgs[i][PGS_WIDTH-1:0] == raw_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
            assign raw_way_hit_kid2[i] = (raw_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)] == raw_vpn_masked[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)])
                                         && raw_way_vld[i];// && ta_cmp_va;
            assign raw_way_hit_kid3[i] = (raw_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)]   == asid_for_va_hit[VPN_PERLEL*1-1:0]);
            assign raw_way_hit_kid4[i] = (raw_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)]  == asid_for_va_hit[ASID_WIDTH-1:VPN_PERLEL*1]);
           ...
           //way final hit logic
            ...
            always_ff@(posedge l2tlb_clk or negedge cpurst_b) begin
                if(!cpurst_b) begin
                    ...
                    final_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]    <= '0;
                    final_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]    <= '0;
                    final_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)]   <= '0;
                    final_way_g[i]      <= 1'b0;
                    final_way_ppn[(i)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]    <= '0;
                    final_way_flg[(i)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]    <= '0;
                end
                else if(raw_vld) begin
                    final_way_vld [i]                 <= raw_way_vld[i];
                    final_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]   <= raw_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)];
                    final_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]   <= raw_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
                    final_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)] <= raw_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)];
                    final_way_g[i]                    <= raw_way_g[i];
                    //DATA_WIDTH = PPN_WIDTH+FLG_WIDTH
                    final_way_ppn[(i)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]   <= raw_way_data[i][DATA_WIDTH-1:FLG_WIDTH];
                    final_way_flg[(i)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]   <= raw_way_data[i][FLG_WIDTH-1:0];
                end
            end
            ...
            assign final_way_asid_hit[i] = final_way_vld[i]
                                         & !final_way_g[i]
                                         & (final_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)] == tlboper_l2tlb_inv_asid[ASID_WIDTH-1:0]);
    ...
    always_comb begin
        ...
        for(int i = 0; i < WAY_NUM; i++) begin
            ...
            if(tlboper_way_sel[i]) begin
                final_idx_vpn  |= final_way_vpn[(i)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)];
                final_idx_pgs  |= final_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
                final_idx_asid |= final_way_asid[(i)*(ASID_WIDTH-1-(0)+1)+0 +: (ASID_WIDTH-1-(0)+1)];
            ...
            if(final_way_sel[i]) begin
                final_hit_ppn  |= final_way_ppn[(i)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)];
                final_hit_flg  |= final_way_flg[(i)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)];
                final_hit_pgs  |= final_way_pgs[(i)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
            end
        end
    end
   ...
   // Outputs
    ...
    //assign final_hit_ppn[PPN_WIDTH-1:0] = {PPN_WIDTH{final_way_sel[0]}} & final_way_ppn[(0)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[1]}} & final_way_ppn[(1)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[2]}} & final_way_ppn[(2)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[3]}} & final_way_ppn[(3)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[4]}} & final_way_ppn[(4)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[5]}} & final_way_ppn[(5)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[6]}} & final_way_ppn[(6)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[7]}} & final_way_ppn[(7)*(PPN_WIDTH-1-(0)+1)+0 +: (PPN_WIDTH-1-(0)+1)];
    //                                      
    //                                  
    //assign final_hit_flg[FLG_WIDTH-1:0] = {PPN_WIDTH{final_way_sel[0]}} & final_way_flg[(0)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[1]}} & final_way_flg[(1)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[2]}} & final_way_flg[(2)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[3]}} & final_way_flg[(3)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[4]}} & final_way_flg[(4)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[5]}} & final_way_flg[(5)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[6]}} & final_way_flg[(6)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)]
    //                                    | {PPN_WIDTH{final_way_sel[7]}} & final_way_flg[(7)*(FLG_WIDTH-1-(0)+1)+0 +: (FLG_WIDTH-1-(0)+1)];
    //                                  
//----------------------------------------------------------
    ...
    always_comb begin
        ...
        for(int i = 0; i < WAY_NUM; i++) begin
            ...
            if(final_way_hit[i]) begin 
                ...
                final_hit_set_idx |= final_bank_index[(i)*(IDX_WIDTH-1-(0)+1)+0 +: (IDX_WIDTH-1-(0)+1)];
            end
        end
    end
