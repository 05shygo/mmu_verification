...
logic [(3-(0)+1)*(PADDR_WIDTH-1-(0)+1)-1:0] twu_mbuf_paddr            ;
logic [(3-(0)+1)*(VPN_WIDTH-1-(0)+1)-1:0] twu_mbuf_vpn              ;
logic [(3-(0)+1)*(TYPE_WIDTH-1-(0)+1)-1:0] twu_mbuf_type             ;
logic [(3-(0)+1)*(ID_WIDTH-1-(0)+1)-1:0] twu_mbuf_id               ;
logic [(3-(0)+1)*(PTE_LEVEL-1-(0)+1)-1:0] twu_mbuf_lvl              ;
logic [(3-(0)+1)*(3-(0)+1)-1:0] twu_mbuf_twu_idx          ;
logic [3:0]                  twu_mbuf_mask             ;
logic [3:0]                  twu_arb_ref_req           ;
logic [(3-(0)+1)*(DATA_WIDTH-1-(0)+1)-1:0] twu_arb_ref_data_din      ;
logic [(3-(0)+1)*(TAG_WIDTH-1-(0)+1)-1:0] twu_arb_ref_tag_din       ;
logic [(3-(0)+1)*(PGS_WIDTH-1-(0)+1)-1:0] twu_arb_ref_pgs           ;
logic [(3-(0)+1)*(TYPE_WIDTH-1-(0)+1)-1:0] twu_arb_ref_type          ;
logic [(3-(0)+1)*(ID_WIDTH-1-(0)+1)-1:0] twu_arb_ref_id            ;
logic [3:0]                  twu_l2tlb_ref_pgflt       ;
logic [(3-(0)+1)*(ID_WIDTH-1-(0)+1)-1:0] twu_l2tlb_ref_pgflt_id    ;
logic [(3-(0)+1)*(TYPE_WIDTH-1-(0)+1)-1:0] twu_l2tlb_ref_pgflt_type  ;
logic [3:0]                  twu_l2tlb_ref_acc_err     ;
logic [(3-(0)+1)*(TYPE_WIDTH-1-(0)+1)-1:0] twu_l2tlb_ref_acc_err_type;
logic [(3-(0)+1)*(ID_WIDTH-1-(0)+1)-1:0] twu_l2tlb_ref_acc_err_id  ;
...
logic [(3-(0)+1)*(PTE_LEVEL-1-(0)+1)-1:0] twu_data_ready     ;
logic                      pgflt_vld          ;
logic                      acc_err_vld        ;
logic                      ref_vld            ;
logic                      pgflt_grant        ;
...
logic [(3-(0)+1)*(7-(0)+1)-1:0] twu_mbuf_pmpflg    ;
...
.twu_mbuf_paddr						(twu_mbuf_paddr[(0)*(PADDR_WIDTH-1-(0)+1)+0 +: (PADDR_WIDTH-1-(0)+1)]				),
.twu_mbuf_vpn						(twu_mbuf_vpn[(0)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]				),
.twu_mbuf_type						(twu_mbuf_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]				),
.twu_mbuf_id						(twu_mbuf_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]					),
.twu_mbuf_lvl						(twu_mbuf_lvl[(0)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]				),
.twu_mbuf_twu_idx					(twu_mbuf_twu_idx[(0)*(3-(0)+1)+0 +: (3-(0)+1)]			),
.twu_mbuf_pmpflg					(twu_mbuf_pmpflg[(0)*(7-(0)+1)+0 +: (7-(0)+1)]				),
...
.twu_arb_ref_data_din				(twu_arb_ref_data_din[(0)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)]		),
.twu_arb_ref_tag_din				(twu_arb_ref_tag_din[(0)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)]			),
.twu_arb_ref_pgs					(twu_arb_ref_pgs[(0)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]				),
.twu_arb_ref_type					(twu_arb_ref_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]			),
.twu_arb_ref_id						(twu_arb_ref_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]				),
                                     
.twu_l2tlb_ref_pgflt				(twu_l2tlb_ref_pgflt[0]			),
.twu_l2tlb_ref_pgflt_id				(twu_l2tlb_ref_pgflt_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]		),
.twu_l2tlb_ref_pgflt_type			(twu_l2tlb_ref_pgflt_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err				(twu_l2tlb_ref_acc_err[0]		),
.twu_l2tlb_ref_acc_err_type			(twu_l2tlb_ref_acc_err_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err_id			(twu_l2tlb_ref_acc_err_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]	),
                                     
.twu_mask							(twu_mask[0]					),
//.twu_idle							(twu_idle[0]					),
.twu_data_ready                     (twu_data_ready[(0)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]     	),
...
.twu_mbuf_paddr						(twu_mbuf_paddr[(1)*(PADDR_WIDTH-1-(0)+1)+0 +: (PADDR_WIDTH-1-(0)+1)]				),
.twu_mbuf_vpn						(twu_mbuf_vpn[(1)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]				),
.twu_mbuf_type						(twu_mbuf_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]				),
.twu_mbuf_id						(twu_mbuf_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]					),
.twu_mbuf_lvl						(twu_mbuf_lvl[(1)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]				),
.twu_mbuf_twu_idx					(twu_mbuf_twu_idx[(1)*(3-(0)+1)+0 +: (3-(0)+1)]			),
.twu_mbuf_pmpflg					(twu_mbuf_pmpflg[(1)*(7-(0)+1)+0 +: (7-(0)+1)]				),
...
.twu_arb_ref_data_din				(twu_arb_ref_data_din[(1)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)]		),
.twu_arb_ref_tag_din				(twu_arb_ref_tag_din[(1)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)]			),
.twu_arb_ref_pgs					(twu_arb_ref_pgs[(1)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]				),
.twu_arb_ref_type					(twu_arb_ref_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]			),
.twu_arb_ref_id						(twu_arb_ref_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]				),
                                     
.twu_l2tlb_ref_pgflt				(twu_l2tlb_ref_pgflt[1]			),
.twu_l2tlb_ref_pgflt_id				(twu_l2tlb_ref_pgflt_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]		),
.twu_l2tlb_ref_pgflt_type			(twu_l2tlb_ref_pgflt_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err				(twu_l2tlb_ref_acc_err[1]		),
.twu_l2tlb_ref_acc_err_type			(twu_l2tlb_ref_acc_err_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err_id			(twu_l2tlb_ref_acc_err_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]	),
                                     
.twu_mask							(twu_mask[1]					),
//.twu_idle							(twu_idle[1]					),
.twu_data_ready                     (twu_data_ready[(1)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]     	),
...
.twu_mbuf_paddr						(twu_mbuf_paddr[(2)*(PADDR_WIDTH-1-(0)+1)+0 +: (PADDR_WIDTH-1-(0)+1)]				),
.twu_mbuf_vpn						(twu_mbuf_vpn[(2)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]				),
.twu_mbuf_type						(twu_mbuf_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]				),
.twu_mbuf_id						(twu_mbuf_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]					),
.twu_mbuf_lvl						(twu_mbuf_lvl[(2)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]				),
.twu_mbuf_twu_idx					(twu_mbuf_twu_idx[(2)*(3-(0)+1)+0 +: (3-(0)+1)]			),
.twu_mbuf_pmpflg					(twu_mbuf_pmpflg[(2)*(7-(0)+1)+0 +: (7-(0)+1)]				),
...
.twu_arb_ref_data_din				(twu_arb_ref_data_din[(2)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)]		),
.twu_arb_ref_tag_din				(twu_arb_ref_tag_din[(2)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)]			),
.twu_arb_ref_pgs					(twu_arb_ref_pgs[(2)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]				),
.twu_arb_ref_type					(twu_arb_ref_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]			),
.twu_arb_ref_id						(twu_arb_ref_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]				),
										
.twu_l2tlb_ref_pgflt				(twu_l2tlb_ref_pgflt[2]			),
.twu_l2tlb_ref_pgflt_id				(twu_l2tlb_ref_pgflt_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]		),
.twu_l2tlb_ref_pgflt_type			(twu_l2tlb_ref_pgflt_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err				(twu_l2tlb_ref_acc_err[2]		),
.twu_l2tlb_ref_acc_err_type			(twu_l2tlb_ref_acc_err_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err_id			(twu_l2tlb_ref_acc_err_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]	),
                                     
.twu_mask							(twu_mask[2]					),
//.twu_idle							(twu_idle[2]					),
.twu_data_ready                     (twu_data_ready[(2)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]     	),
...
.twu_mbuf_paddr						(twu_mbuf_paddr[(3)*(PADDR_WIDTH-1-(0)+1)+0 +: (PADDR_WIDTH-1-(0)+1)]				),
.twu_mbuf_vpn						(twu_mbuf_vpn[(3)*(VPN_WIDTH-1-(0)+1)+0 +: (VPN_WIDTH-1-(0)+1)]				),
.twu_mbuf_type						(twu_mbuf_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]				),
.twu_mbuf_id						(twu_mbuf_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]					),
.twu_mbuf_lvl						(twu_mbuf_lvl[(3)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]				),
.twu_mbuf_twu_idx					(twu_mbuf_twu_idx[(3)*(3-(0)+1)+0 +: (3-(0)+1)]			),
.twu_mbuf_pmpflg					(twu_mbuf_pmpflg[(3)*(7-(0)+1)+0 +: (7-(0)+1)]				),
...
.twu_arb_ref_data_din				(twu_arb_ref_data_din[(3)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)]		),
.twu_arb_ref_tag_din				(twu_arb_ref_tag_din[(3)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)]			),
.twu_arb_ref_pgs					(twu_arb_ref_pgs[(3)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)]				),
.twu_arb_ref_type					(twu_arb_ref_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]			),
.twu_arb_ref_id						(twu_arb_ref_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]				),
										
.twu_l2tlb_ref_pgflt				(twu_l2tlb_ref_pgflt[3]			),
.twu_l2tlb_ref_pgflt_id				(twu_l2tlb_ref_pgflt_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]		),
.twu_l2tlb_ref_pgflt_type			(twu_l2tlb_ref_pgflt_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err				(twu_l2tlb_ref_acc_err[3]		),
.twu_l2tlb_ref_acc_err_type			(twu_l2tlb_ref_acc_err_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)]	),
.twu_l2tlb_ref_acc_err_id			(twu_l2tlb_ref_acc_err_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)]	),
                                     
.twu_mask							(twu_mask[3]					),
//.twu_idle							(twu_idle[3]					),
.twu_data_ready                     (twu_data_ready[(3)*(PTE_LEVEL-1-(0)+1)+0 +: (PTE_LEVEL-1-(0)+1)]     	),
...
.twu_mbuf_twu_idx					(twu_mbuf_twu_idx		),
...
always_comb begin
	case(pgflt_twu_grant[3:0])
		4'b0001	: begin		
			...
			ptw_l2tlb_pgflt_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_pgflt_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_pgflt_id[ID_WIDTH-1:0] = twu_l2tlb_ref_pgflt_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		4'b0010	: begin		
			//ptw_l2tlb_ref_pgflt = 1'b1;
			ptw_l2tlb_pgflt_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_pgflt_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_pgflt_id[ID_WIDTH-1:0] = twu_l2tlb_ref_pgflt_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		4'b0100	: begin		
			//ptw_l2tlb_ref_pgflt = 1'b1;
			ptw_l2tlb_pgflt_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_pgflt_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_pgflt_id[ID_WIDTH-1:0] = twu_l2tlb_ref_pgflt_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		4'b1000	: begin		
			//ptw_l2tlb_ref_pgflt = 1'b1;
			ptw_l2tlb_pgflt_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_pgflt_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_pgflt_id[ID_WIDTH-1:0] = twu_l2tlb_ref_pgflt_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		default 	: begin
...
always_comb begin
	case(acc_err_twu_grant[5:0])
		6'b000001	: begin		
			...
			ptw_l2tlb_acc_err_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_acc_err_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_acc_err_id[ID_WIDTH-1:0] = twu_l2tlb_ref_acc_err_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		6'b000010	: begin		
			//ptw_l2tlb_ref_acc_err = 1'b1;
			ptw_l2tlb_acc_err_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_acc_err_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_acc_err_id[ID_WIDTH-1:0] = twu_l2tlb_ref_acc_err_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		6'b000100	: begin		
			//ptw_l2tlb_ref_acc_err = 1'b1;
			ptw_l2tlb_acc_err_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_acc_err_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_acc_err_id[ID_WIDTH-1:0] = twu_l2tlb_ref_acc_err_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		6'b001000	: begin		
			//ptw_l2tlb_ref_acc_err = 1'b1;
			ptw_l2tlb_acc_err_type[TYPE_WIDTH-1:0] = twu_l2tlb_ref_acc_err_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_l2tlb_acc_err_id[ID_WIDTH-1:0] = twu_l2tlb_ref_acc_err_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		6'b010000	: begin		
			//ptw_l2tlb_ref_acc_err = 1'b1;
...
assign fst_twu_itlb_sel = twu_arb_ref_req[0] & twu_arb_ref_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)] == 3'b011;
assign scd_twu_itlb_sel = twu_arb_ref_req[1] & twu_arb_ref_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)] == 3'b011;
assign thd_twu_itlb_sel = twu_arb_ref_req[2] & twu_arb_ref_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)] == 3'b011;
assign fth_twu_itlb_sel = twu_arb_ref_req[3] & twu_arb_ref_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)] == 3'b011;
...
always_comb begin
	case(refill_arb_twu_grant[3:0])
		4'b0001	: begin
			ptw_arb_ref_data_din[DATA_WIDTH-1:0] = twu_arb_ref_data_din[(0)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)];
			ptw_arb_ref_tag_din[TAG_WIDTH-1:0] = twu_arb_ref_tag_din[(0)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)];
			ptw_arb_ref_pgs[PGS_WIDTH-1:0] = twu_arb_ref_pgs[(0)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
			ptw_arb_ref_type[TYPE_WIDTH-1:0] = twu_arb_ref_type[(0)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_arb_ref_id[ID_WIDTH-1:0] = twu_arb_ref_id[(0)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		4'b0010	: begin
			ptw_arb_ref_data_din[DATA_WIDTH-1:0] = twu_arb_ref_data_din[(1)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)];
			ptw_arb_ref_tag_din[TAG_WIDTH-1:0] = twu_arb_ref_tag_din[(1)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)];
			ptw_arb_ref_pgs[PGS_WIDTH-1:0] = twu_arb_ref_pgs[(1)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
			ptw_arb_ref_type[TYPE_WIDTH-1:0] = twu_arb_ref_type[(1)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_arb_ref_id[ID_WIDTH-1:0] = twu_arb_ref_id[(1)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end	
		4'b0100	: begin
			ptw_arb_ref_data_din[DATA_WIDTH-1:0] = twu_arb_ref_data_din[(2)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)];
			ptw_arb_ref_tag_din[TAG_WIDTH-1:0] = twu_arb_ref_tag_din[(2)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)];
			ptw_arb_ref_pgs[PGS_WIDTH-1:0] = twu_arb_ref_pgs[(2)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
			ptw_arb_ref_type[TYPE_WIDTH-1:0] = twu_arb_ref_type[(2)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_arb_ref_id[ID_WIDTH-1:0] = twu_arb_ref_id[(2)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		4'b1000	: begin
			ptw_arb_ref_data_din[DATA_WIDTH-1:0] = twu_arb_ref_data_din[(3)*(DATA_WIDTH-1-(0)+1)+0 +: (DATA_WIDTH-1-(0)+1)];
			ptw_arb_ref_tag_din[TAG_WIDTH-1:0] = twu_arb_ref_tag_din[(3)*(TAG_WIDTH-1-(0)+1)+0 +: (TAG_WIDTH-1-(0)+1)];
			ptw_arb_ref_pgs[PGS_WIDTH-1:0] = twu_arb_ref_pgs[(3)*(PGS_WIDTH-1-(0)+1)+0 +: (PGS_WIDTH-1-(0)+1)];
			ptw_arb_ref_type[TYPE_WIDTH-1:0] = twu_arb_ref_type[(3)*(TYPE_WIDTH-1-(0)+1)+0 +: (TYPE_WIDTH-1-(0)+1)];
			ptw_arb_ref_id[ID_WIDTH-1:0] = twu_arb_ref_id[(3)*(ID_WIDTH-1-(0)+1)+0 +: (ID_WIDTH-1-(0)+1)];
		end
		default	: begin
